...
% Export the data to a binary file (f32 floating point or 16-bit integer) <br>
...
% <https://www.tdt.com/files/examples/TDTExampleData.zip example data sets> and extracted
